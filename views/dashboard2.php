                                    ...
                                    <div class="card-body">
                                        <div class="card bg-light text-center mb-4">
                                            ...
                                            <div class="card-footer d-flex align-items-center text-center justify-content-between">
                                                <div class="w-100">
                                                    <a href="consignar.php" class="btn btn-outline-success shadow-sm" style="width: 140px;"><i class="fa-solid fa-arrow-up"></i> Consignar</a>
                                                    <a href="retirar.php" class="btn btn-outline-secondary shadow-sm" style="width: 140px;"><i class="fa-solid fa-arrow-down"></i> Retirar</a>
                                                    <a href="transferir.php" class="btn btn-outline-warning shadow-sm" style="width: 140px;"><i class="fa-solid fa-arrow-right-arrow-left"></i> Transferir</a>
                                                    <a href="movimiento.php" class="btn btn-outline-primary shadow-sm" style="width: 140px;"><i class="fa-solid fa-receipt"></i> Movimientos</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
